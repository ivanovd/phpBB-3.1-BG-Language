...
$lang = array_merge($lang, array(
	...
	<br />
	Вашата парола е криптирана (с еднопосочен хеш) за да бъде защитена. Въпреки това е препоръчително да не използвате една и съща парола в различни сайтове. Вашата парола е начинът Ви за достъп до профилът Ви в “%1$s”, затова, моля, пазете я внимателно. При никакви обстоятелства някой свързан с “%1$s”, phpBB или трето лице, няма право да Ви пита за паролата Ви. Ако забравите паролата за просила си, можете да използвате “Забравих си паролата” фукцията, предоставена от phpBB софтуера. При този процес, ще Ви бъде поискано да въведете потребителското си име и емейл, след което phpBB софтуерът ще генерира нова парола за да достъпите отново профила си.<br />
	',
));
